...
class ColorfulCleanLinedTemplate extends StatelessWidget with InvoiceTemplateHelpers {
  @override final Invoice invoice;
  @override final BusinessInfo business;
  @override final String Function(double) fmtMoney;
  const ColorfulCleanLinedTemplate({super.key, required this.invoice, required this.business, required this.fmtMoney});
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text('INVOICE', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w100, letterSpacing: 12)),
            Padding(
  ...
  Widget buildTotalsWithAccent(Color accent) {
    return Align(alignment: Alignment.centerRight, child: Text('Total: ${fmtMoney(invoice.totalAmount)}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 20)));
  }
}

// 18. Colorful Yellow Blue Split